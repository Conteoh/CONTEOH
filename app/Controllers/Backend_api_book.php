...
class Backend_api_book extends BaseResourceController
{
    use ResponseTrait;
    ...
    public function submit(){
        try {
            ...
            if (isset($_SERVER["CONTENT_TYPE"]) && strpos($_SERVER["CONTENT_TYPE"], "application/json") !== false) {
				...
				$bought_date = $this->request->getVar("bought_date_temp");
				$completed_date = $this->request->getVar("completed_date_temp");
                ...
                $submit_data = [
					...
					"total_page" => !empty($total_page)?$total_page:0,
					"bought_date" => !empty($bought_date)?$bought_date:null,
					"completed_date" => !empty($completed_date)?$completed_date:null,
