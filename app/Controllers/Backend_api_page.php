...
class Backend_api_page extends BaseResourceController
{
    use ResponseTrait;
    ...
    public function submit(){
        try {
            ...
            if (isset($_SERVER["CONTENT_TYPE"]) && strpos($_SERVER["CONTENT_TYPE"], "application/json") !== false) {
				...
				$seo_h1 = $this->request->getVar("seo_h1");
				$seo_p1 = $this->request->getVar("seo_p1");
				$seo_h2 = $this->request->getVar("seo_h2");
				$seo_p2 = $this->request->getVar("seo_p2");
				$ogimg = $this->request->getVar("ogimg");
                ...
                $submit_data = [
					...
					"meta_keyword" => !empty($meta_keyword)?$meta_keyword:null,
					"seo_h1" => !empty($seo_h1)?$seo_h1:null,
					"seo_p1" => !empty($seo_p1)?$seo_p1:null,
					"seo_h2" => !empty($seo_h2)?$seo_h2:null,
					"seo_p2" => !empty($seo_p2)?$seo_p2:null,
					"ogimg" => !empty($ogimg)?$ogimg:null,
