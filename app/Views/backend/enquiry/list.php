                        ...
                        <div class="card-body">
                            <form name="filter_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="mobile" name="mobile" placeholder="Mobile" ng-model="filter_data.mobile">
                                </div>
                            </div>
									<div class="col-md-4 mb-2">
                                    <div class="form-group">
                            ...
                            <div class="table-responsive">
                                <table ng-table="tableParams" class="table table-bordered table-sm b-result-list-table" show-filter="false">
                                    <tr ng-repeat="item in $data" class="text-center">
										...
										<td title="'Mobile'">{{item.mobile}}</td>
										<td title="'Status'">{{status_kv_list[item.status]}}</td>
