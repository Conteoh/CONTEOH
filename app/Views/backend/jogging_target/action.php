                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <!-- <input type="text" class="form-control" id="year" placeholder="Year" ng-model="form_data.year"> -->
                                            <select name="year" id="year" class="form-control" ng-model="form_data.year" required>
                                                <option value="">Select Year</option>
                                                <?php for ($i = date('Y', strtotime('+1 year')); $i >= 2025; $i--): ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="month_01">Month 01 (KM)</label>
                                            <input type="number" step=".01" class="form-control" id="month_01" placeholder="Month 01" ng-model="form_data.month_01" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="month_02">Month 02 (KM)</label>
                                            <input type="number" step=".01" class="form-control" id="month_02" placeholder="Month 02" ng-model="form_data.month_02" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="month_03">Month 03 (KM)</label>
                                            <input type="number" step=".01" class="form-control" id="month_03" placeholder="Month 03" ng-model="form_data.month_03" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="month_04">Month 04 (KM)</label>
                                            <input type="number" step=".01" class="form-control" id="month_04" placeholder="Month 04" ng-model="form_data.month_04" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="month_05">Month 05 (KM)</label>
                                            <input type="number" step=".01" class="form-control" id="month_05" placeholder="Month 05" ng-model="form_data.month_05" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="month_06">Month 06 (KM)</label>
                                            <input type="number" step=".01" class="form-control" id="month_06" placeholder="Month 06" ng-model="form_data.month_06" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="month_07">Month 07 (KM)</label>
                                            <input type="number" step=".01" class="form-control" id="month_07" placeholder="Month 07" ng-model="form_data.month_07" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="month_08">Month 08 (KM)</label>
                                            <input type="number" step=".01" class="form-control" id="month_08" placeholder="Month 08" ng-model="form_data.month_08" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="month_09">Month 09 (KM)</label>
                                            <input type="number" step=".01" class="form-control" id="month_09" placeholder="Month 09" ng-model="form_data.month_09" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="month_10">Month 10 (KM)</label>
                                            <input type="number" step=".01" class="form-control" id="month_10" placeholder="Month 10" ng-model="form_data.month_10" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="month_11">Month 11 (KM)</label>
                                            <input type="number" step=".01" class="form-control" id="month_11" placeholder="Month 11" ng-model="form_data.month_11" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="month_12">Month 12 (KM)</label>
                                            <input type="number" step=".01" class="form-control" id="month_12" placeholder="Month 12" ng-model="form_data.month_12" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    app.controller("myCtrl", function($scope, $http, $timeout) {
        ...
        if ($scope.id && $scope.id > 0) {
            ...
            // Convert month fields to number type for number input fields
            for (var i = 1; i <= 12; i++) {
                var monthKey = 'month_' + (i < 10 ? '0' + i : i);
                if ($scope.form_data[monthKey] !== undefined && $scope.form_data[monthKey] !== null && $scope.form_data[monthKey] !== '') {
                    $scope.form_data[monthKey] = parseFloat($scope.form_data[monthKey]);
                }
            }
