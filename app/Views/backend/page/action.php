                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="slug" placeholder="Slug" ng-model="form_data.slug">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="meta_title">Meta Title</label>
                                            <textarea class="form-control" id="meta_title" placeholder="Meta Title" ng-model="form_data.meta_title" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="meta_description">Meta Description</label>
                                            <textarea class="form-control" id="meta_description" placeholder="Meta Description" ng-model="form_data.meta_description" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <div class="form-group">
                                            <label for="meta_keyword">Meta Keyword</label>
                                            <textarea class="form-control" id="meta_keyword" placeholder="Meta Keyword" ng-model="form_data.meta_keyword" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <label for="seo_h1">SEO H1</label>
                                            <textarea class="form-control" id="seo_h1" placeholder="SEO H1" ng-model="form_data.seo_h1" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <label for="seo_p1">SEO P1</label>
                                            <textarea class="form-control" id="seo_p1" placeholder="SEO P1" ng-model="form_data.seo_p1" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <label for="seo_h2">SEO H2</label>
                                            <textarea class="form-control" id="seo_h2" placeholder="SEO H2" ng-model="form_data.seo_h2" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            <label for="seo_p2">SEO P2</label>
                                            <textarea class="form-control" id="seo_p2" placeholder="SEO P2" ng-model="form_data.seo_p2" rows="5"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            <label for="ogimg">OGImg (1200x630PX)</label>
                                            <div>
                                                <div class="mb-1" ng-if="form_data.ogimg">
                                                    <a href="{{form_data.ogimg}}" target="_blank"><img ng-src="{{form_data.ogimg}}" id="ogimg_photo" class="img-fluid" /></a>
                                                </div>
                                                <input type="file" class="form-control" id="ogimg" ng-files="getTheFiles($files,'ogimg')" ng-disabled="form_data.is_uploading_ogimg==1" />
                                                <input type="text" style="display:none" ng-model="form_data.ogimg" />

                                                <div class="mt-1">
                                                    <button type="button" id="upload_btn_ogimg" class="btn btn-secondary btn-sm" ng-click="uploadFiles('1200','630','ogimg')" ng-disabled="form_data.is_uploading_ogimg==1"><i class="fa fa-upload"></i> Upload <i class="fa fa-spinner fa-spin" ng-if="form_data.is_uploading_ogimg==1"></i></button>
                                                    <button type="button" class="btn btn-danger btn-sm" ng-click="form_data.ogimg=''" ng-if="form_data.ogimg"><i class="fa fa-trash"></i> Remove</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="content" placeholder="Content" ng-model="form_data.content" rows="5" ck-editor></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
