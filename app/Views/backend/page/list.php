                        ...
                        <div class="card-body">
                            <form name="filter_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="slug" name="slug" placeholder="Slug" ng-model="filter_data.slug">
                                </div>
                            </div>
									<div class="col-md-4 mb-2">
                                <div class="form-group">
                                    <label for="ogimg">OGImg</label>
                                    <input type="text" class="form-control form-control-sm" id="ogimg" name="ogimg" placeholder="OGImg" ng-model="filter_data.ogimg">
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table ng-table="tableParams" class="table table-bordered table-sm b-result-list-table" show-filter="false">
                                    <tr ng-repeat="item in $data" class="text-center">
										...
										<td title="'Slug'">{{item.slug}}</td>
										<td title="'OGImg'"><img ng-src="{{item.ogimg}}" class="img-fluid" width="150px"></td>
