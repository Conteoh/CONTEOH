                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="price" name="price" placeholder="Price" ng-model="filter_data.price">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-2">
                                        <div class="form-group">
                                            <label for="completed_date">Completed Date</label>
                                            <input type="date" class="form-control form-control-sm" id="completed_date" name="completed_date" ng-model="filter_data.completed_date">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table ng-table="tableParams" class="table table-bordered table-sm b-result-list-table" show-filter="false">
                                    <tr ng-repeat="item in $data" class="text-center">
                                        ...
                                        <td title="'Completed Date'">{{item.completed_date}}</td>
