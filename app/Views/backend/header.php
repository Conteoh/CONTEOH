            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul
                        ...
                        <!--Expenditure-->
                        <?php if (!$site_config['backend_check_permission'] || (isset($my_permission_list['expenditure']) && $my_permission_list['expenditure']['can_view'])): ?>
                            <li class="nav-item <?= $current_module == 'expenditure' ? 'menu-open' : '' ?>">
                                <a href="#" class="nav-link">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?= base_url(BACKEND_PORTAL . '/expenditure/list') ?>" class="nav-link <?= $current_module == 'expenditure' && $current_page == 'list' ? 'active' : '' ?>">
                                            <i class="nav-icon bi bi-list"></i>
                                            <p>List</p>
                                        </a>
                                    </li>
                                    <?php if (!$site_config['backend_check_permission'] || (isset($my_permission_list['expenditure']) && $my_permission_list['expenditure']['can_add'])): ?>
                                        <li class="nav-item">
                                            <a href="<?= base_url(BACKEND_PORTAL . '/expenditure/add') ?>" class="nav-link <?= $current_module == 'expenditure' && ($current_page == 'add' || $current_page == 'edit') ? 'active' : '' ?>">
                                                <i class="nav-icon bi bi-plus"></i>
                                                <p>Add</p>
                                            </a>
                                        </li>
                        ...
                        <!--Jogging-->
                        <?php if (!$site_config['backend_check_permission'] || (isset($my_permission_list['jogging']) && $my_permission_list['jogging']['can_view'])): ?>
                            <li class="nav-item <?= $current_module == 'jogging' ? 'menu-open' : '' ?>">
                                <a href="#" class="nav-link">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?= base_url(BACKEND_PORTAL . '/jogging/list') ?>" class="nav-link <?= $current_module == 'jogging' && $current_page == 'list' ? 'active' : '' ?>">
                                            <i class="nav-icon bi bi-list"></i>
                                            <p>List</p>
                                        </a>
                                    </li>
                                    <?php if (!$site_config['backend_check_permission'] || (isset($my_permission_list['jogging']) && $my_permission_list['jogging']['can_add'])): ?>
                                        <li class="nav-item">
                                            <a href="<?= base_url(BACKEND_PORTAL . '/jogging/add') ?>" class="nav-link <?= $current_module == 'jogging' && ($current_page == 'add' || $current_page == 'edit') ? 'active' : '' ?>">
                                                <i class="nav-icon bi bi-plus"></i>
                                                <p>Add</p>
                                            </a>
                                        </li>
