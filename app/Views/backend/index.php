                ...
                <ul class="navbar-nav ms-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img
                                            src="./backend/assets/img/user1-128x128.jpg"
                                            alt="User Avatar"
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img
                                            src="./backend/assets/img/user8-128x128.jpg"
                                            alt="User Avatar"
                                            class="img-size-50 rounded-circle me-3" />
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img
                                            src="./backend/assets/img/user3-128x128.jpg"
                                            alt="User Avatar"
                                            class="img-size-50 rounded-circle me-3" />
                                    </div>
                                    <div class="flex-grow-1">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img
                                src="./backend/assets/img/user2-160x160.jpg"
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="./index.html" class="brand-link">
                    <!--begin::Brand Image-->
                    <img
                        src="./backend/assets/img/AdminLTELogo.png"
                        alt="AdminLTE Logo"
                                    ...
                                    <table class="table table-striped align-middle">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img
                                                        src="./backend/assets/img/default-150x150.png"
                                                        alt="Product 1"
