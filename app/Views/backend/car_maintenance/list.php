                        ...
                        <div class="card-body">
                            <form name="filter_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="total_amount" name="total_amount" placeholder="Price" ng-model="filter_data.total_amount">
                                </div>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table ng-table="tableParams" class="table table-bordered table-sm b-result-list-table" show-filter="false">
                                    <tr ng-repeat="item in $data" class="text-center">
										...
										<td title="'Price'">{{item.total_amount}}</td>
