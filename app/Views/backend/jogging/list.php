                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm" id="section" name="section" ng-model="filter_data.section">
                                                <option value="">All</option>
                                                <?php if (isset($section_kv_list) && !empty($section_kv_list)): ?>
                                                    <?php foreach ($section_kv_list as $k => $v): ?>
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="distance_in_km" name="distance_in_km" placeholder="Distance in KM" ng-model="filter_data.distance_in_km">
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="photo" name="photo" placeholder="Photo" ng-model="filter_data.photo">
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table ng-table="tableParams" class="table table-bordered table-sm b-result-list-table" show-filter="false">
                                    <tr ng-repeat="item in $data" class="text-center">
                                        ...
                                        <td title="'Section'">{{section_kv_list[item.section]}}</td>
                                        <td title="'Distance in KM'">{{item.distance_in_km}}</td>
                                        <td title="'Location'">{{item.location}}</td>
                                        <td title="'Photo'"><img ng-src="{{item.photo}}" class="img-fluid" width="150px"></td>
...
<script>
    ...
    app.controller("myCtrl", function($scope, $http, $timeout, NgTableParams, $resource) {
        ...
        $scope.section_kv_list = <?= isset($section_kv_list) ? json_encode($section_kv_list) : '[]' ?>;
